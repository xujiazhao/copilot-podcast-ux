...
const PODCAST_PLAYLIST = [
  ...
  {
    id: 8,
    title: "Grammys 2026: Beyoncé Breaks Record with Historic Win",
    category: "Entertainment",
    duration: "5:33",
    sources: 4,
    ...
    detailedSources: [
      { name: "Vox", logo: "publisher icon/Vox.png", article: "Beyoncé Makes Grammy History", time: "1h ago" },
      { name: "Time", logo: "publisher icon/Time.png", article: "The Most Awarded Artist in Grammy History", time: "2h ago" },
      { name: "Insider", logo: "publisher icon/Insider.png", article: "Every Winner at the 2026 Grammys", time: "3h ago" },
      { name: "USA Today", logo: "publisher icon/USA Today.png", article: "Grammys 2026: Complete Coverage and Highlights", time: "4h ago" }
    ]
  },
  {
    id: 9,
    ...
    image: "https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?w=150",
    detailedSources: [
      { name: "Guardian", logo: "publisher icon/Guardian.png", article: "World Leaders Agree to Historic Carbon Reduction", time: "1h ago" },
      { name: "BBC", logo: "publisher icon/BBC.png", article: "Climate Summit: Key Takeaways", time: "2h ago" },
      { name: "NPR", logo: "publisher icon/NPR.png", article: "What the New Climate Agreement Means", time: "3h ago" },
      { name: "Reuters", logo: "publisher icon/Reuters.png", article: "Nations Commit to Net Zero by 2040", time: "4h ago" },
      { name: "NYT", logo: "publisher icon/NYT.png", article: "Inside the Climate Summit Negotiations", time: "5h ago" },
      { name: "Washington Post", logo: "publisher icon/Washington Post.png", article: "A New Era for Global Climate Action", time: "6h ago" }
    ]
  },
  {
    id: 10,
    title: "Tesla Stock Surges After Record Q4 Deliveries Announced",
    category: "Business",
    duration: "5:47",
    sources: 5,
    sourceNames: "Bloomberg,CNBC,WSJ,Forbes,Business Insider",
    gradient: "from-violet-400 to-purple-600",
    image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=150",
    detailedSources: [
      { name: "Bloomberg", logo: "publisher icon/Bloomberg.png", article: "Tesla Beats Delivery Expectations", time: "1h ago" },
      { name: "CNBC", logo: "publisher icon/CNBC.png", article: "Tesla Stock Jumps on Record Sales", time: "2h ago" },
      { name: "WSJ", logo: "publisher icon/WSJ.png", article: "Tesla's Q4 Success Story", time: "3h ago" },
      { name: "Forbes", logo: "publisher icon/Forbes.png", article: "What Record Deliveries Mean for Tesla Investors", time: "4h ago" },
      { name: "Business Insider", logo: "publisher icon/Business Insider.png", article: "Tesla's Global Expansion Pays Off", time: "5h ago" }
    ]
  },
  {
    id: 11,
    ...
    duration: "7:12",
    sources: 4,
    sourceNames: "ArsTechnica,Wired,Reuters,BBC",
    gradient: "from-slate-400 to-gray-600",
    image: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=150",
    detailedSources: [
      { name: "Ars Technica", logo: "publisher icon/ArsTechnica.png", article: "Massive Data Breach Affects Millions", time: "1h ago" },
      { name: "Wired", logo: "publisher icon/Ramdom1.png", article: "Inside the Biggest Breach of 2026", time: "2h ago" },
      { name: "Reuters", logo: "publisher icon/Reuters.png", article: "Company Responds to Security Incident", time: "3h ago" },
      { name: "BBC", logo: "publisher icon/BBC.png", article: "Experts Warn of Identity Theft Risk", time: "4h ago" }
    ]
  },
  ...
  {
    id: 12,
    title: "Microsoft Announces Major Azure AI Update for Enterprise",
    category: "Technology",
    duration: "6:15",
    sources: 4,
    sourceNames: "Bloomberg,Reuters,WSJ,Forbes",
    gradient: "from-blue-400 to-indigo-600",
    image: "https://images.unsplash.com/photo-1633419461186-7d40a38105ec?w=150",
    detailedSources: [
      { name: "Bloomberg", logo: "publisher icon/Bloomberg.png", article: "Microsoft Azure AI Gets Major Upgrade", time: "1h ago" },
      { name: "Reuters", logo: "publisher icon/Reuters.png", article: "Azure Copilot Expands Enterprise Features", time: "2h ago" },
      { name: "WSJ", logo: "publisher icon/WSJ.png", article: "Microsoft's AI Strategy for Business", time: "3h ago" },
      { name: "Forbes", logo: "publisher icon/Forbes.png", article: "How Azure AI Is Transforming Enterprise", time: "4h ago" }
    ]
  },
  {
    id: 13,
    ...
    duration: "5:42",
    sources: 5,
    sourceNames: "CNBC,Bloomberg,Reuters,Forbes,Business Insider",
    gradient: "from-orange-400 to-amber-600",
    image: "https://images.unsplash.com/photo-1518546305927-5a555bb7020d?w=150",
    detailedSources: [
      { name: "CNBC", logo: "publisher icon/CNBC.png", article: "Bitcoin Breaks $100K Barrier", time: "1h ago" },
      { name: "Bloomberg", logo: "publisher icon/Bloomberg.png", article: "Institutional Money Flows Into Crypto", time: "2h ago" },
      { name: "Reuters", logo: "publisher icon/Reuters.png", article: "Bitcoin ETFs See Record Inflows", time: "3h ago" },
      { name: "Forbes", logo: "publisher icon/Forbes.png", article: "Why Bitcoin Is Rallying in 2026", time: "4h ago" },
      { name: "Business Insider", logo: "publisher icon/Business Insider.png", article: "The New Era of Institutional Crypto", time: "5h ago" }
    ]
  },
  {
    id: 14,
    title: "China's New Space Station Welcomes International Crew",
    category: "Science",
    duration: "7:33",
    sources: 6,
    sourceNames: "BBC,NPR,AP,Reuters,CNN,Guardian",
    gradient: "from-indigo-400 to-violet-600",
    image: "https://images.unsplash.com/photo-1446776811953-b23d57bd21aa?w=150",
    detailedSources: [
      { name: "BBC", logo: "publisher icon/BBC.png", article: "Tiangong Station Hosts First International Astronauts", time: "1h ago" },
      { name: "NPR", logo: "publisher icon/NPR.png", article: "China Opens Space Station to World", time: "2h ago" },
      { name: "AP", logo: "publisher icon/AP.png", article: "Historic Moment for Space Cooperation", time: "3h ago" },
      { name: "Reuters", logo: "publisher icon/Reuters.png", article: "International Crew Arrives at Chinese Station", time: "4h ago" },
      { name: "CNN", logo: "publisher icon/CNN.png", article: "What Tiangong Means for Space Diplomacy", time: "5h ago" },
      { name: "Guardian", logo: "publisher icon/Guardian.png", article: "A New Chapter in Human Spaceflight", time: "6h ago" }
    ]
  },
  {
    id: 15,
    title: "Oscar Nominations 2026: Complete List of Surprises",
    category: "Entertainment",
    duration: "4:58",
    sources: 3,
    sourceNames: "Vox,Time,USA Today",
    gradient: "from-rose-400 to-pink-600",
    image: "https://images.unsplash.com/photo-1485846234645-a62644f84728?w=150",
    detailedSources: [
      { name: "Vox", logo: "publisher icon/Vox.png", article: "Oscar Nominations: The Biggest Snubs and Surprises", time: "1h ago" },
      { name: "Time", logo: "publisher icon/Time.png", article: "2026 Oscar Nominees Announced", time: "2h ago" },
      { name: "USA Today", logo: "publisher icon/USA Today.png", article: "Complete Oscar Nominations List", time: "3h ago" }
    ]
  },
  {
    id: 16,
